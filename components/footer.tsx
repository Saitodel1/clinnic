    ...
    <footer className="bg-foreground text-background py-16 lg:py-20">
      <div className="container mx-auto px-6">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          <div className="sm:col-span-2 lg:col-span-1">
            <a href="/" className="flex items-center gap-3 mb-6">
              ...
              <span className="font-serif text-xl tracking-tight">Косметология</span>
            </a>
            <p className="text-background/60 text-sm leading-relaxed mb-6 max-w-xs">
              Премиум косметологическая клиника в Астане. Современные технологии и индивидуальный подход.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-background/60">{clinicContact.address}</span>
              </li>
              <li>
                <a
        ...
        <div className="pt-8 border-t border-background/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-background/40">© {currentYear} Косметология. Все права защищены.</p>
